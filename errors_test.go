...
func TestWrap(t *testing.T) {
	...
	for _, tt := range tests {
		got := Wrap(tt.err, tt.msg).Error()
		if got != tt.want {
			t.Errorf("Wrap(%v, %q)>>> got: %v, want: %v", tt.err, tt.msg, got, tt.want)
		}
	}
}
...
func TestWrapfNil(t *testing.T) {
	...
	if got != nil {
		t.Errorf("Wrapf(nil, \"no error\")>>> got: %#v, want: nil", got)
	}
}
...
func TestWithMessagefNil(t *testing.T) {
	...
	if got != nil {
		t.Errorf("WithMessage(nil, \"no error\")>>> got %#v, want: nil", got)
	}
}
